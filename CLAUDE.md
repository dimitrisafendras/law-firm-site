...
The site ships **sixteen colour combinations** — eight schemes, each with a light and a dark version — (`src/theme/palettes.ts`). A palette
...
- The other fourteen are generated by `makePalette` from a twelve-value **seed**.
