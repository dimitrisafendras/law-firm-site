const el = {
  ...
  editHint: 'Επεξεργαστείτε το <code>src/App.tsx</code> και αποθηκεύστε για δοκιμή <code>HMR</code>',
  countIs: 'Μέτρηση: {{count}}',
  documentation: 'Τεκμηρίωση',
  questionsAnswered: 'Οι ερωτήσεις σας, απαντημένες',
  exploreVite: 'Εξερευνήστε το Vite',
  learnMore: 'Μάθετε περισσότερα',
  connectWithUs: 'Επικοινωνήστε μαζί μας',
  joinCommunity: 'Γίνετε μέλος της κοινότητας Vite',
