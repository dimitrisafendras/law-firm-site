...
const el = {
  ...
  attorney1Name: 'Στυλιανός Βλάχος',
  attorney1Title: 'Διευθύνων Εταίρος',
  attorney1Bio:
    'Ο Στυλιανός φέρνει οξεία συναλλακτική ενστικτο στους πελάτες ακινήτων και startups. Γνωστός για τη δόμηση σύνθετων συμφωνιών ακινήτων και την καθοδήγηση ιδρυτών σε κρίσιμα ορόσημα χρηματοδότησης.',
  attorney1Spec1: 'Εταιρικό Δίκαιο',
  attorney1Spec2: 'Fintech',
  attorney1Spec3: 'Επιχειρηματικά Κεφάλαια',
  attorney1Focus: 'Συναλλακτική Στρατηγική',
  attorney1Origin: 'Αθήνα',

  attorney2Name: 'Πολυτίμη Κωνσταντακοπούλου',
  attorney2Title: 'Ιδρυτική Εταίρος',
  attorney2Bio:
    'Η Πολυτίμη πλοηγείται στη διασταύρωση παραδοσιακού ναυτικού δικαίου και ψηφιακών περιουσιακών. Η διπλή εξειδίκευσή της επιτρέπει στους πελάτες να κινούνται με σιγουριά.',
  ...
  editEmpty: 'Κενό \u2014 κάντε κλικ για κείμενο',

  // ─── Attorney 3 (crypto) ─────────────────────────────────────────────────────
  attorney3Name: 'Ευάγγελος Μαστροδήμας',
  attorney3Title: 'Ιδρυτικός Εταίρος',
  attorney3Bio:
    'Ο Ευάγγελος συμβουλεύει ιδρυτές και επενδυτικά σχήματα που δραστηριοποιούνται στο ρυθμιστικό μέτωπο των ψηφιακών περιουσιακών στοιχείων. Δομεί εκδόσεις tokens, καθοδηγεί πρωτόκολλα στην αδειοδότηση MiCA και χειρίζεται διαφορές όπου ο κώδικας συναντά το δίκαιο των συμβάσεων.',
  ...
  menuMode: 'Ύφος',
  modePickerOpen: 'Ύφος',
  modePickerLegend: 'Ύφος',
  modeDigital: 'Ψηφιακό',
  modeDigitalHint: 'Μάρμαρο που διαλύεται σε φως',
  modeClassic: 'Κλασικό',
  modeClassicHint: 'Μάρμαρο, χρυσός και Garamond',
  menuStatue: 'Άγαλμα',
  statuePickerOpen: 'Άγαλμα',
  statuePickerLegend: 'Άγαλμα',
  statueAuto: 'Κατά το θέμα',
  statueAutoHint: 'Αποφασίζουν η παλέτα και το ύφος',
  statueCyan: 'Κυανό',
  ...
  dsEditableTextNote:
    ...
    + 'Αν αδειάσει ένα πεδίο, στην προβολή διαχειριστή μένει διακεκομμένο placeholder αντί να εξαφανιστεί το στοιχείο, ώστε το κείμενο να μπορεί να επανέλθει· '
    + 'οι επισκέπτες εξακολουθούν να μη βλέπουν τίποτα.',
