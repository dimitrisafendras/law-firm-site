...
const el = {
  ...
  dsMarbleTitle: 'Μάρμαρο — το δεύτερο υλικό',
  dsMarbleBody: 'Δεν είναι φωτεινό θέμα: ο ιστότοπος δεν έχει εναλλαγή θέματος. Το μάρμαρο είναι μια αδιαφανής ανοιχτόχρωμη επιφάνεια που επιλέγει μια ενότητα με data-material="marble", από τα tokens colors.light. Υπάρχει ώστε μια σελίδα 8.600px να έχει ένα τονικό ορόσημο.',
  dsMarbleSampleName: 'Χαραγμένο όνομα',
  dsMarbleSampleRole: 'Ακίνητα & Χρηματοδότηση Startup',
  dsMarbleGlassNote: 'Το γυαλί μέσα στο μάρμαρο παίρνει αυτόματα τις φωτεινές τιμές — τίποτα εδώ δεν ορίζει χρώμα με το χέρι.',
  dsMarbleElevation: 'Υψομετρία μαρμάρου',
