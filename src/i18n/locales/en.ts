const en = {
  ...
  liquidGlass: 'Liquid Glass Material',
  liquidGlassIntro:
    'Three layers: a highlight on the top edge, an interior illumination that lenses the backdrop, and a shadow that separates it from the canvas. Hover an interactive surface to see the lensing shift.',
  materialRegular: 'Regular',
  materialRegularUse: 'The default. Legible over anything.',
  materialClear: 'Clear',
  materialClearUse: 'Thinner. Only over bright media — needs a scrim.',
  materialAccent: 'Accent',
  materialAccentUse: 'Near-solid tint for emphasis surfaces.',
  materialInteractive: 'Interactive',
  materialInteractiveUse: 'Lifts and saturates on hover.',
  elevation: 'Elevation',
  ...
  menuMode: 'Look',
  modePickerOpen: 'Look',
  modePickerLegend: 'Look',
  modeDigital: 'Digital',
  modeDigitalHint: 'Marble dissolving into light',
  modeClassic: 'Classic',
  modeClassicHint: 'Marble, gold and Garamond',
  menuStatue: 'Statue',
  statuePickerOpen: 'Statue',
  statuePickerLegend: 'Statue',
  statueAuto: 'Follow the theme',
  statueAutoHint: 'The palette and the look decide',
  statueCyan: 'Cyan',
  ...
  dsAuthNavControlNote:
    'The navbar auth affordance. Renders a sign-in link when signed out, the account link when signed in, and an admin badge for admins. Renders nothing while the session is still resolving.',
